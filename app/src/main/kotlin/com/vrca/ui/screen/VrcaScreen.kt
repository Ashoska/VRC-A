...
fun VrcaScreen(
    ...
    // (The single-session HARD-DENY screen was removed — the account centre is
    // multi-device now: additional same-account devices are authorized members,
    // not blocked. See docs/account-system-plan.md §5.)
