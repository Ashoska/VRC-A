...
object FeatureSessionStore {
    ...
    /** Persist the current toggle state and arm restore for the next process launch. */
    fun save(context: Context, afk: Boolean, cycle: Boolean, spotify: Boolean, time: Boolean) {
        try {
            prefs(context).edit()
